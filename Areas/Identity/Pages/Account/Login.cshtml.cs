...
namespace ProyectoFinalAplicada2.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Dede de ingresar su nombre de usuario.")]
            [Display(Name = "Nombre De Usuario")]
            public string Name { get; set; }

            [Required(ErrorMessage = "Debe Ingresar su contraseña de usuario.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Intento de iniciar sesión fallo.");
                    return Page();
                }
            }
